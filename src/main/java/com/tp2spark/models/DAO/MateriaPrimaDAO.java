...
public class MateriaPrimaDAO implements IMateriaPrimaDAO {
    ...
    } // Actualizar una materia prima (se podria mejorar considerando el caso que alguno de los parametros pueda venir con valor null, para evitar excepciones y/o errores).
